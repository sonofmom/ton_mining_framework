#include "Libraries/mining/opencl/includes/inc_miner.h"
#include "Libraries/mining/opencl/includes/inc_miner.cl"
...
__kernel void crunch(
        __global const u32x *data_init_hash,
        __global const u32x *data_init_w,
    ...
    */
    ...
    for (iterations_counter = 0; iterations_counter < iterations_max; iterations_counter++) {
        ...
        digest[0] = data_init_hash[0];
        digest[1] = data_init_hash[1];
        digest[2] = data_init_hash[2];
        digest[3] = data_init_hash[3];
        digest[4] = data_init_hash[4];
        digest[5] = data_init_hash[5];
        digest[6] = data_init_hash[6];
        digest[7] = data_init_hash[7];
        ...
        w3[3] = bytealign (w3[2], w3[3], 3);
        w3[2] = bytealign (w3[1], w3[2], 3);
        w3[1] = bytealign (w3[0], w3[1], 3);
        w3[0] = bytealign (w2[3], w3[0], 3);
        w2[3] = bytealign (w2[2], w2[3], 3);
        w2[2] = bytealign (w2[1], w2[2], 3);
        w2[1] = bytealign (w2[0], w2[1], 3);
        w2[0] = bytealign (w1[3], w2[0], 3);
        w1[3] = bytealign (w1[2], w1[3], 3);
        w1[2] = bytealign (w1[1], w1[2], 3);
        w1[1] = bytealign (w1[0], w1[1], 3);
        w1[0] = bytealign (w0[3], w1[0], 3);
        w0[3] = bytealign (w0[2], w0[3], 3);
        w0[2] = bytealign (w0[1], w0[2], 3);
        w0[1] = bytealign (w0[0], w0[1], 3);
        w0[0] = bytealign (    0, w0[0], 3);
        ...
        */
        ...
        if (found == 1) {
            ...
            */
            solution[0] = prefix_l;
            solution[1] = counter;
            solution[2] = data_seed[0];
            solution[3] = data_seed[1];
            solution[4] = data_seed[2];
            solution[5] = data_seed[3];
            solution[6] = data_rand[0];
            solution[7] = data_rand[1];
            solution[8] = data_rand[2];
            solution[9] = data_rand[3];
            solution[10] = data_rand[4];
            solution[11] = data_rand[5];
            solution[12] = prefix_l;
            solution[13] = counter;
