...
KERNEL_FQ void crunch(
        __global const sha256_ctx_t *shactx1,
    ...
    */
    ...
    for (iterations_counter = 0; iterations_counter < iterations_max; iterations_counter++) {
        ...
        shactx2.len = shactx1->len;
        shactx2.h[0] = shactx1->h[0];
        shactx2.h[1] = shactx1->h[1];
        shactx2.h[2] = shactx1->h[2];
        shactx2.h[3] = shactx1->h[3];
        shactx2.h[4] = shactx1->h[4];
        shactx2.h[5] = shactx1->h[5];
        shactx2.w0[0] = shactx1->w0[0];
        shactx2.w0[1] = shactx1->w0[1];
        shactx2.w0[2] = shactx1->w0[2];
        shactx2.w0[3] = shactx1->w0[3];
        shactx2.w1[0] = shactx1->w1[0];
        shactx2.w1[1] = shactx1->w1[1];
        shactx2.w1[2] = shactx1->w1[2];
        shactx2.w1[3] = shactx1->w1[3];
        shactx2.w2[0] = shactx1->w2[0];
        shactx2.w2[1] = shactx1->w2[1];
        shactx2.w2[2] = shactx1->w2[2];
        shactx2.w2[3] = shactx1->w2[3];
        shactx2.w3[0] = shactx1->w3[0];
        shactx2.w3[1] = shactx1->w3[1];
        shactx2.w3[2] = shactx1->w3[2];
        shactx2.w3[3] = shactx1->w3[3];
